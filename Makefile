...
deploy-proxy:
	@forge script script/DeploySmallProxy.s.sol:DeploySmallProxy $(NETWORK_ARGS)

deploy-implA:
	@forge script script/DeploySmallProxy.s.sol:DeployImplementatioA $(NETWORK_ARGS)

deploy-implB:
	@forge script script/DeploySmallProxy.s.sol:DeployImplementatioB $(NETWORK_ARGS)
